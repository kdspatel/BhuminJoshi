    ...
    <section className="section" id="services">
      <div className="container">
        ...
        <div className="relative mt-16">
          ...
          <div
            className="
              relative -mt-16 sm:-mt-20 md:-mt-28
              lg:absolute lg:bottom-[-60px] lg:right-10 lg:w-[600px]
              w-[92%] mx-auto
            "
          >
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-5 sm:p-6 lg:p-10 shadow-2xl">

              <h2 className="text-xl sm:text-2xl lg:text-3xl font-semibold mb-3 text-white">
                Events Photography
              </h2>

              <p className="text-neutral-200 mb-4 text-sm sm:text-base leading-relaxed">
                With over a decade of experience, we capture moments that feel
                real, timeless, and deeply personal. Every story is approached
                with a cinematic eye and emotional depth.
              </p>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {serviceHighlights.map((item) => (
                    <div
                      key={item.id}
                      className="px-3 py-2 bg-neutral-800 border border-neutral-600 text-xs sm:text-sm text-white tracking-wide hover:bg-white hover:text-black transition duration-300 cursor-pointer flex items-center gap-2"
                    >
